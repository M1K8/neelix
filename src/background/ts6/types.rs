...
pub struct MovedEventPayload {
    ...
    pub properties: MovedEventProperties,
    #[serde(rename = "type")]
    pub type_field: i64,
    pub visibility: i64,
}
...
#[derive(Default, Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct MovedEventProperties {
    pub away: bool,
    pub away_message: String,
    pub badges: String,
    pub channel_group_id: String,
...
#[derive(Default, Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct ClientPropertiesChanged {
    pub away: bool,
    pub away_message: String,
    pub badges: String,
    pub channel_group_id: String,
...
pub enum WsEvent {
    #[serde(rename = "auth")]
    Auth {
        payload: auth::AuthEventPayload,
        status: Status,
    },
    #[serde(rename = "clientMoved")]
    NotifyClientMoved { payload: MovedEventPayload },
    ...
    TalkStatusChanged { payload: TalkStatusChangedPayload },

    #[serde(rename = "notifyClientUpdated")]
    NotifyClientUpdated { payload: ClientUpdatedPayload },
    #[serde(rename = "notifyClientLeftView")]
    NotifyClientLeftView { payload: ClientLeftPayload },
    #[serde(rename = "notifyClientEnterView")]
    NotifyClientEnterView { payload: ClientEnterPayload },
    #[serde(rename = "textMessage")]
    NotifyTextMessageReceived { payload: MessageRecvPayload },
    #[serde(other)]
    Unknown,
}
